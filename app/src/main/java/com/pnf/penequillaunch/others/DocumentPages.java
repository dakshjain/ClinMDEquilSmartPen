...
public class DocumentPages {
    ...
    public DocumentPages(String UGCId,String firstName, String lastName, String mobile, String date, String age, String gender, String nextPage, String doctor, String page, String followUp, String diagnose) {
    ...
    public DocumentPages(String pageId){
