...
public class Mail extends javax.mail.Authenticator {
    ...
    public Mail() {
        _host = "smtpout.asia.secureserver.net"; // default smtp server
        _port = "465"; // default smtp port
        _sport = "465"; // default socketfactory port

        _user = "info@clinmd.com"; // username
        _pass = "Clinmddoc@9932"; // password
        _from = "info@clinmd.com"; // email sent from
    ...
    public boolean send() throws Exception {
        ...
        Log.d("Email", _user);
        Log.d("Email", _pass);
        Log.d("Email", "Length"+_to.length+"");
        Log.d("Email", _subject);
        Log.d("Email", _body);
        if (!_user.equals("")
                && !_pass.equals("")
                && _to.length > 0
