...
public class DotDetailsDatabaseHandler {
    private static final String timestamp = "timestamp";
    private static final String pageid = "pageid";
    private static final String filename = "filename";
    private static final String type = "type";

    private static final String TableName  = "page_details";

    private static final String DBName = "status.db";
    private static final int DBVersion = 3;


    private static final String Table_Create = "create table if not exists page_details (" +
    ...
    public DotDetailsDatabaseHandler(Context context) {
    ...
    public Cursor returnPageList_asc(){
        return sql.rawQuery("SELECT pageid from "+TableName+" order by pageid asc",null);

    }

    public Cursor returnPageNameAnddate(int pageid) {
        return sql.rawQuery("SELECT filename , timestamp from "+TableName+" where pageid = "+pageid,null);
    }
